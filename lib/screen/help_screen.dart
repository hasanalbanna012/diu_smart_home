...
final List<FAQItem> faqList = [
  FAQItem(
    ...
    answer:
        'To add a new device, go to the Devices section and tap the "+" button. Follow the on-screen instructions to connect your device to the network.',
  ),
  FAQItem(
    question: 'How can I create automation routines?',
    answer:
        'Navigate to the Settings screen and select "Automation". Here you can create custom routines based on time, device status, or other triggers.',
  ),
  FAQItem(
    question: 'What should I do if a device is offline?',
    answer:
        'First, check if the device is powered on and within range of your WiFi network. Try restarting the device and your router if issues persist.',
  ),
  FAQItem(
    question: 'How do I manage user access?',
    answer:
        'Go to the Manage Users section to add, remove, or modify user permissions. You can set different access levels for each user.',
  ),
  FAQItem(
    question: 'Can I control devices when I\'m away from home?',
    answer:
        'Yes! As long as your phone has an internet connection, you can control your smart home devices from anywhere.',
  ),
];
